...
void max_pokemon(char* data, enum Generation gen)
{
    ...
    pkx_set_value(data, gen, EV_HP, 255);
    pkx_set_value(data, gen, EV_ATK, 255);
    pkx_set_value(data, gen, EV_DEF, 255);
    pkx_set_value(data, gen, EV_SPATK, 255);
    pkx_set_value(data, gen, EV_SPDEF, 255);
    pkx_set_value(data, gen, EV_SPEED, 255);
}
